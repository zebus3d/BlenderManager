...
# 3 filas de tarjetas caben en el hueco que dejan la cabecera, los filtros y el
# pie. Lo vigila un test que comprueba que la rejilla no necesita scroll.
# El ancho (1160) es el que necesitan las **ocho** pestañas de canal cuando los
# dos forks están activos (Todas, LTS, Estable, Diarias, Experimentales,
# Bforartists, UPBGE, Favoritos: 718 px) más el botón de refrescar, la vista y
# los dos combos. Con menos, la última pestaña se recortaba contra el refrescar
# y parecía no existir. Aun así la barra lleva botones de scroll para anchos
# menores.
DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT = 1160, 665
MIN_WINDOW_WIDTH, MIN_WINDOW_HEIGHT = 665, 500
